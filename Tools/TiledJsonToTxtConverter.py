...
solidObjectData = data["layers"][1]["objects"];

solidObjectFile = open("solidObjectData.txt",'w')
solidObjectFile.write(str(len(solidObjectData)) + "\n")
for solidObject in solidObjectData:
	solidObjectFile.write(str(solidObject["x"]) + " ")
	solidObjectFile.write(str(solidObject["y"]) + " ")
	solidObjectFile.write(str(solidObject["width"]) + " ")
	solidObjectFile.write(str(solidObject["height"]) + "\n")
